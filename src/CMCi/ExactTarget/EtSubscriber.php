...
class EtSubscriber extends EtBaseClass
{
     ...
     *
     * @param CMCi\ExactTarget\EtAttribute $EtAttribute
     *
     * @return boolean
     * @throws \Exception
     */
    ...
    {
        if (!($EtAttribute instanceof \CMCi\ExactTarget\EtAttribute)) {
            throw new \Exception(" updateAttribute expects an instance of \CMCi\ExactTarget\EtAttribute and was given ".get_class(
                $EtAttribute
            ).". ");
        }
